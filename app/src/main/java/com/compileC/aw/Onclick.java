...
public class Onclick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        re = FirebaseDatabase.getInstance().getReference().child( "nob" );
        String nobkey = getIntent().getStringExtra( "nobkey" );
        ...
        re.child( nobkey ).addValueEventListener( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(getApplication()).load(Nurl).into(nimage);
...
//=====================================================================================================
    private void shareImage() {
        ...
        try {
            ...
            intent.putExtra( Intent.EXTRA_STREAM, FileProvider.getUriForFile( Onclick.this,BuildConfig.APPLICATION_ID+".provider",file ) );
