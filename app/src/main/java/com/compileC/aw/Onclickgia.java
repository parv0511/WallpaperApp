...
public class Onclickgia extends AppCompatActivity {
    TextView ntitle;
    ImageView nimage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        re = FirebaseDatabase.getInstance().getReference().child( "gia" );
        String nobkey = getIntent().getStringExtra( "giakey" );
    ...
    private void shareImage() {
        ...
        try {
            ...
            intent.putExtra( Intent.EXTRA_STREAM, FileProvider.getUriForFile( com.compileC.aw.Onclickgia.this,BuildConfig.APPLICATION_ID+".provider",file ) );
