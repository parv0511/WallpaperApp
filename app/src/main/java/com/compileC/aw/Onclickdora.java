...
import java.util.Locale;
        ...
        public class Onclickdora  extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            re = FirebaseDatabase.getInstance().getReference().child( "dora" );
            String nobkey = getIntent().getStringExtra( "dorakey" );
        ...
        private void shareImage() {
            ...
            try {
                ...
                intent.putExtra( Intent.EXTRA_STREAM, FileProvider.getUriForFile( com.compileC.aw.Onclickdora.this,BuildConfig.APPLICATION_ID+".provider",file ) );
