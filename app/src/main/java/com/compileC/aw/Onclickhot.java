...
public class Onclickhot  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        re = FirebaseDatabase.getInstance().getReference().child( "hot" );
    ...
    private void shareImage() {
        ...
        try {
            ...
            intent.putExtra( Intent.EXTRA_STREAM, FileProvider.getUriForFile( com.compileC.aw.Onclickhot.this,BuildConfig.APPLICATION_ID+".provider",file ) );
