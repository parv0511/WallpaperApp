...
public class Onclicksun  extends AppCompatActivity {
    TextView ntitle;
    ImageView nimage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        re = FirebaseDatabase.getInstance().getReference().child( "sun" );
        String nobkey = getIntent().getStringExtra( "sunkey" );
    ...
    private void shareImage() {
        ...
        try {
            ...
            intent.putExtra( Intent.EXTRA_STREAM, FileProvider.getUriForFile( com.compileC.aw.Onclicksun.this,BuildConfig.APPLICATION_ID+".provider",file ) );
